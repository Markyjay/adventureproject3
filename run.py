...
def get_cell_value(worksheet_name, cell, line_width=80):
...
def main():
    ...
    '''
    clear_screen()
    wrap_and_print(cell_values['A3'])
    time.sleep(2)
    wrap_and_print(cell_values['A4'])
    while True:
        choice_cx = input("Type 'c' or 'x':\n").lower()
        if choice_cx == 'c':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['A5'])
            while True:
                ...
                if choice_lfr == 'f':
                    ...
                    clear_screen()
                    time.sleep(1)
                    wrap_and_print(cell_values['B6'])
                    while True:
                        choice_fb = input("Type 'f' or 'b':\n").lower()
                        if choice_fb == 'f':
                            clear_screen()
                            time.sleep(1)
                            wrap_and_print(cell_values['B1'])
                            start_again_loop()
                        elif choice_fb == 'b':
                            clear_screen()
                            time.sleep(1)
                            wrap_and_print(cell_values['B7'])
                            while True:
...
def junction_loop():
    ...
    while True:
        ...
        if choice_123 == '1':
            ...
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['D3'])
            while True:
                choice_iq = input("Type 'i' or 'q':\n").lower()
                if choice_iq == 'i':
                    clear_screen()
                    time.sleep(1)
                    wrap_and_print(cell_values['E6'])
                    while True:
                        choice_cm = input("Type 'c' or 'm':\n").lower()
                        if choice_cm == 'c':
                            clear_screen()
                            time.sleep(1)
                            wrap_and_print(cell_values['F7'])
                            time.sleep(1)
                            start_again_loop()
                        elif choice_cm == 'm':
                            clear_screen()
...
def tend_wound():
    wrap_and_print(cell_values['C3'])
    while True:
        choice_hc = input("Type 'h' or 'c':\n").lower()
        if choice_hc == 'h':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['C2'])
            while True:
                choice_sr = input("Type 's' or 'r':\n").lower()
                if choice_sr == 's':
                    clear_screen()
                    time.sleep(1)
                    wrap_and_print(cell_values['F1'])
                    time.sleep(1)
                    start_again_loop()
                elif choice_sr == 'r':
                    clear_screen()
                    time.sleep(1)
                    wrap_and_print(cell_values['C1'])
                    while True:
                        continue_forward = input("Type 'c':\n").lower()
                        if continue_forward == 'c':
                            clear_screen()
...
def bridge_loop():
    ...
    Each loop has an else section for any invalid inputs the user may use.
    '''
    wrap_and_print(cell_values['E2'])
    while True:
        choice_bj = input("Type 'b' or 'j':\n").lower()
        if choice_bj == 'b':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['F2'])
            time.sleep(1)
            start_again_loop()
        elif choice_bj == 'j':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['F3'])
            while True:
                choice_jr = input("Type 'j' or 'r':\n").lower()
                if choice_jr == 'j':
                    clear_screen()
                    time.sleep(1)
                    wrap_and_print(cell_values['D8'])
                    time.sleep(1)
                    start_again_loop()
                elif choice_jr == 'r':
                    clear_screen()
                    time.sleep(1)
                    wrap_and_print(cell_values['C8'])
                    while True:
                        choice_sc = input("Type 's' or 'c':\n").lower()
                        if choice_sc == 's':
                            clear_screen()
                            time.sleep(1)
                            wrap_and_print(cell_values['H5'])
                            time.sleep(1)
                            start_again_loop()
                        elif choice_sc == 'c':
                            clear_screen()
...
def weapon_loop():
    ...
    while True:
        ...
        if choice_we == 'w':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['H6'])
            time.sleep(1)
            start_again_loop()
        elif choice_we == 'e':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['H8'])
            while True:
                choice_lw = input("Type 'l' or 'w':\n").lower()
                if choice_lw == 'l':
                    clear_screen()
                    time.sleep(1)
                    wrap_and_print(cell_values['B2'])
                    while True:
                        choice_sf = input("Type 's' or 'f':\n").lower()
                        if choice_sf == 's':
                            clear_screen()
                            time.sleep(1)
                            wrap_and_print(cell_values['G5'])
                            time.sleep(1)
                            start_again_loop()
                        elif choice_sf == 'f':
                            clear_screen()
                            time.sleep(1)
                            wrap_and_print(cell_values['G6'])
                            while True:
                                choice_ab = input("Type 'a' or 'b':\n").lower()
                                if choice_ab == 'a':
                                    clear_screen()
                                    time.sleep(1)
                                    wrap_and_print(cell_values['H1'])
                                    time.sleep(1)
                                    start_again_loop()
                                elif choice_ab == 'b':
                                    clear_screen()
...
def inside_truck_loop():
    wrap_and_print(cell_values['C6'])
    while True:
        choice_wo = input("Type 'o' or 'w':\n").lower()
        if choice_wo == 'o':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['D6'])
            time.sleep(1)
            start_again_loop()
        elif choice_wo == 'w':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['E8'])
            while True:
...
def river_loop():
    ...
    Each loop has an else section for any invalid inputs the user may use.
    '''
    wrap_and_print(cell_values['B5'])
    while True:
        choice_hg = input("Type 'h' or 'g':\n").lower()
        if choice_hg == 'h':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['D4'])
            while True:
                choice_st = input("Type 's' or 't':\n").lower()
                if choice_st == 's':
                    clear_screen()
                    time.sleep(1)
                    wrap_and_print(cell_values['D7'])
                    while True:
                        choice_wr = input("Type 'w' or 'r':\n").lower()
                        if choice_wr == 'w':
                            clear_screen()
                            time.sleep(1)
                            wrap_and_print(cell_values['G1'])
                            while True:
...
def hide_loop():
    ...
    Each loop has an else section for any invalid inputs the user may use.
    '''
    wrap_and_print(cell_values['F6'])
    while True:
        choice_be = input("Type 'b' or 'e':\n").lower()
        if choice_be == 'b':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['B8'])
        elif choice_be == 'e':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['H8'])
...
def scrap_river_loop():
    wrap_and_print(cell_values['E7'])
    while True:
...
def move_on_loop():
    ...
    Each loop has an else section for any invalid inputs the user may use.
    '''
    wrap_and_print(cell_values['F8'])
    while True:
        choice_cb = input("Type 'c' or 'b':\n").lower()
        if choice_cb == 'c':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['G3'])
            while True:
...
def distract():
    wrap_and_print(cell_values['H2'])
    while True:
        choice_rw = input("Type 'r' or 'w':\n").lower()
        if choice_rw == 'r':
            clear_screen()
            time.sleep(1)
            wrap_and_print(cell_values['H4'])
...
'''
while True:
    choice_yn = input("Start your adventure? (y/n):\n").lower()
    if choice_yn == "y":
